...
def station_stats(df):
    ...
    print("The Most Common Start Station is:-", commonly_start)
    # display most commonly used end station
    commonly_end = df['End Station'].mode()[0]
    print("The Most Common End Station is:-", commonly_end)
    # display most frequent combination of start station and end station trip
    combination_station = df['Start Station'] + " to " + df['End Station']
    combination_start_end = combination_station.mode()[0]
    print("The Most Common Trip from Start to End is :- {}".format(combination_start_end))
